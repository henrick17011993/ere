...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $query = "SELECT o.STATUS, p.idproduto, p.quantidade, p.imagem
                  FROM orcamento o
                  JOIN produtosorcamento p ON o.idorcamento = p.idorcamento
        ...
        if ($result) {
            foreach ($result as $row) {
                ...
                $updateQuery = "UPDATE orcamento SET STATUS = 'Em Andamento' WHERE idorcamento = :idorcamento";
                ...
                $checkQuery = "SELECT idestoque, imagem, Nfora FROM estoque WHERE imagem = :imagem";
                ...
                if ($existingProduct) {
                    ...
                    $updateEstoqueQuery = "UPDATE estoque SET Nfora = :novaQuantidade WHERE imagem = :imagem";
                    ...
                    $insertEstoqueQuery = "INSERT INTO estoque (idproduto, Nfora, imagem) VALUES (:idproduto, :quantidade, :imagem)";
