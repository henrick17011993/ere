                                ...
                                <tr>
                                    <td>
                                        <div class="image-container">
                                            <img src="<?= htmlspecialchars($produto["IMAGEM"], ENT_QUOTES, 'UTF-8') ?>" alt="Imagem" onerror="this.onerror=null; this.src='/caminho/para/imagem-padrao.jpg'; this.src='uploads/logoere.png';">
                                        </div>
                                    </td>
                                    <td><?= $produto["TIPO"] ?></td>
